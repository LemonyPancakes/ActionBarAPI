 ...
 */
package me.lemonypancakes.bukkit.common.actionbarapi.v1_13_R2;
...
public class CraftActionBar implements ActionBar {
    ...
    public void sendMessage(Player player, String message) {
        ...
        PacketPlayOutChat packetPlayOutChat = new PacketPlayOutChat(iChatBaseComponent, ChatMessageType.a((byte) 2));
